...
exports.removeActivityFromStop = async (req, res) => {
  try {
    ...
    // Prisma doesn't support deleting by non-unique fields directly if there's no unique compound identifier defined
    // Wait, we have @@unique([stopId, activityId], name: "uq_stop_activities_stop_activity")
