...
const TripNotes = () => {
  ...
  return (
    <div className="app-container" style={{ backgroundColor: '#F9FAFB', flexDirection: 'column' }}>
      
      {/* Streamlined Header for standalone app */}
      <header style={styles.header}>
        <div style={styles.brand}>
          <h2 style={{ color: 'var(--primary)', margin: 0, fontSize: '1.5rem', fontWeight: '700' }}>Traveloop</h2>
          <span style={{ color: 'var(--text-secondary)', marginLeft: '1rem' }}>Journal App</span>
        </div>
      </header>
      ...
      <main style={styles.mainContent}>
        <div style={styles.pageHeader}>
          <div>
            <h1 style={styles.title}>Your Trip Notes</h1>
